    ...
    <form id="form1" runat="server">
        ...
        <div class="col-50">
            <div id="PurchaseInfo" class="container">
                ...
                <p><span class="PIText">Ones: </span><asp:Label ID="lblOnes" class=price runat="server" Text="0"></asp:Label></p>
                <p><span class="PIText">Fives: </span><asp:Label ID="lblFives" class=price runat="server" Text="0"></asp:Label></p>
                <p><span class="PIText">Twenty Fives: </span><asp:Label ID="lblTwentyFives" class=price runat="server" Text="0"></asp:Label></p>
                <p><span class="PIText">Hundreds: </span><asp:Label ID="lblHundreds" class=price runat="server" Text="0"></asp:Label></p>
                <p><span class="PIText">TwoHundredFifties: </span><asp:Label ID="lblTwoHundredFifties" class=price runat="server" Text="0"></asp:Label></p>
                <hr />
